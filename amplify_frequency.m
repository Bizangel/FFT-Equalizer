...
% Aplica un filtro de escalado/amplificado, usando una ventana rectangular.
...
amplified(w0_index:w1_index) = Fxs(w0_index:w1_index)*alpha; % Se escala ambas ventanas.
